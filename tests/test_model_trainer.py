...
class TestRFRTrainerInit:
    ...
    def test_init_with_parameters(
        self, minimal_preprocessor, minimal_feature_engineer, minimal_param_grid
    ):
    ...
    def test_init_creates_pipeline(
        self, minimal_preprocessor, minimal_feature_engineer, minimal_param_grid
    ):
...
class TestRFRTrainerTraining:
    ...
    def test_train_new_model_returns_pipeline(
        self,
        minimal_preprocessor,
        minimal_feature_engineer,
        minimal_param_grid,
    ...
    def test_train_new_model_performs_grid_search(
        ...
        param_grid = {"model__n_estimators": [5, 10], "model__max_depth": [2, 3]}
...
class TestRFRTrainerEdgeCases:
    ...
    def test_handles_minimal_data(self, minimal_preprocessor, minimal_feature_engineer):
        ...
        param_grid = {"model__n_estimators": [5], "model__max_depth": [2]}
