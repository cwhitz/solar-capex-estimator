...
class TestDataLoaderValidation:
    ...
    def test_validate_filters_invalid_year_range(self, temp_data_dir):
        ...
        with pytest.raises(ValueError, match="year_min cannot be greater than year_max"):
            loader._validate_filters(year_min=2022, year_max=2020, customer_segments=None)
    ...
    def test_validate_filters_invalid_customer_segments_type(self, temp_data_dir):
        ...
        with pytest.raises(ValueError, match="must be a list of strings"):
            loader._validate_filters(year_min=None, year_max=None, customer_segments='COM')
    ...
    def test_validate_filters_invalid_customer_segments_values(self, temp_data_dir):
        ...
        with pytest.raises(ValueError, match="must be a subset"):
            loader._validate_filters(year_min=None, year_max=None, customer_segments=['INVALID'])
