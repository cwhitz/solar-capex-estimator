...
def sample_raw_data():
    ...
    return pd.DataFrame({
        ...
        'PV_system_size_DC': [100.5, 200.0, 50.0, 150.0, 300.0, 75.0, 125.0, 250.0, 90.0, 180.0],
        'total_installed_price': [150000, 300000, 75000, 225000, 450000, 112500, 187500, 375000, 135000, 270000],
        'state': ['CA', 'TX', 'NY', 'CA', 'TX', 'NY', 'CA', 'TX', 'NY', 'CA'],
        'utility_service_territory': ['PG&E', 'Oncor', 'ConEd', 'PG&E', 'Oncor', 'ConEd', 'PG&E', 'Oncor', 'ConEd', 'PG&E'],
        ...
        'zip_code': ['94102', '75201', '10001', '94103', '75202', '10002', '94104', '75203', '10003', '94105'],
        'city': ['San Francisco', 'Dallas', 'New York', 'San Francisco', 'Dallas',
                 'New York', 'San Francisco', 'Dallas', 'New York', 'San Francisco'],
    })
...
def sample_raw_data_with_missing():
    ...
    data = pd.DataFrame({
        'installation_date': pd.date_range('2020-01-01', periods=10, freq='M'),
        'customer_segment': ['COM'] * 10,
        'PV_system_size_DC': [100.5, 200.0, 50.0, -1, 300.0, 75.0, 125.0, -1, 90.0, 180.0],
        'total_installed_price': [150000, 300000, np.nan, 225000, 5, 112500, 187500, 375000, np.nan, 270000],
...
def sample_cleaned_data():
    ...
    return pd.DataFrame({
        ...
        'PV_system_size_DC': [100.5, 200.0, 150.0, 300.0, 75.0, 125.0, 250.0, 180.0],
        'total_installed_price': [150000, 300000, 225000, 450000, 112500, 187500, 375000, 270000],
        'state': ['CA', 'TX', 'CA', 'TX', 'NY', 'CA', 'TX', 'CA'],
        'utility_service_territory': ['PG&E', 'Oncor', 'PG&E', 'Oncor', 'ConEd', 'PG&E', 'Oncor', 'PG&E'],
